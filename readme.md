...
2. Копируем jar на наш VPS переименовав его одновременно в bot.jar: `scp build/libs/KotlinTelegramBot-1.0-SNAPSHOT-all.jar root@100.100.100.100:/root/bot.jar`
